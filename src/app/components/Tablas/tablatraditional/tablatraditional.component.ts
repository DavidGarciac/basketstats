...
import { Rowarray } from 'src/app/models/Rowarray.model';
...
@Component({
  selector: 'app-tablatraditional',
  templateUrl: './tablatraditional.component.html',
  styleUrls: ['./tablatraditional.component.css']
})
export class TablatraditionalComponent implements OnInit {
  // tslint:disable-next-line: max-line-length
  ...
  CargarTabla(){
  // console.log( this.selectedSortOrder, this.selectedSortOrderType);
